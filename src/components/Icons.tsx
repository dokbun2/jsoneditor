...
// 포맷 아이콘 (정렬)
export const FormatIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// 압축 아이콘
export const CompressIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// 수정/복구 아이콘
export const RepairIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Undo 아이콘
export const UndoIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Redo 아이콘
export const RedoIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// 글자 크기 아이콘
export const TextSizeIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// 체크 완료된 박스 아이콘
export const CheckedBoxIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
